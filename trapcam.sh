...
sed 's+forwarding_link+'$link'+g' trapcam.html > index2.html
...
sed 's+forwarding_link+'$send_link'+g' trapcam.html > index2.html
...
default_subdomain="trapcam$RANDOM"
